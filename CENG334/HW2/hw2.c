...
int main(int argc, char const *argv[]) {
    ...
    for (int i = 0; i < r1; ++i) { int *r = (int*) malloc(sizeof(int)); *r = i; pthread_create(addfirst_threads+i, NULL, add_first, r); }
    for (int i = 0; i < r3; ++i) { int *r = (int*) malloc(sizeof(int)); *r = i; pthread_create(addsecnd_threads+i, NULL, add_second, r); }
    for (int i = 0; i < r1; ++i) { int *r = (int*) malloc(sizeof(int)); *r = i; pthread_create(multiply_threads+i, NULL, multiply, r); }

    for (int i = 0; i < r1; ++i) pthread_join(addfirst_threads[i], NULL);
    for (int i = 0; i < r3; ++i) pthread_join(addsecnd_threads[i], NULL);
    for (int i = 0; i < r1; ++i) pthread_join(multiply_threads[i], NULL);
