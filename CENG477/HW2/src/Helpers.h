...
/*
 * Translate vertex (Vec3) using the translation values and return the new vertex (Vec3).
 */
Vec3 translateVec3(Vec3 vertex, Translation translation);

/*
 * Scale vertex (Vec3) using the scale values and return the new vertex (Vec3).
 */
Vec3 scaleVec3(Vec3 vertex, Scaling scale);

/*
 * Rotate vertex (Vec3) using the rotation values and return the new vertex (Vec3).
 */
