...
w1 = torch.normal(mean=0, std=1, size=(32, 2), requires_grad=True)
...
b1 = torch.normal(mean=0, std=1, size=(32, 1), requires_grad=True)
#b1 = torch.empty(32).normal_(mean=0, std=1)
...
w2 = torch.normal(mean=0, std=1, size=(1, 32), requires_grad=True)
...
b2 = torch.normal(mean=0, std=1, size=(1,1), requires_grad=True)
#b2= torch.empty(1).normal_(mean=0, std=1)
