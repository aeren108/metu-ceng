...
#line 134 "parser.tab.cc"
  ...
  ParserBase::ParserBase (MyParser *driver_yyarg)
#if YYDEBUG
    : yydebug_ (false),
      yycdebug_ (&std::cerr),
#else
  ...
  template <typename Base>
  ParserBase::basic_symbol<Base>::basic_symbol (typename Base::kind_type t)
    : Base (t)
    , value ()
  {}

  template <typename Base>
  ParserBase::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, YY_RVREF (value_type) v)
    : Base (t)
    , value (YY_MOVE (v))
  {}
    ...
    yylen = yyr2_[yyn];
    {
      ...
      try
#endif // YY_EXCEPTIONS
        {
          switch (yyn)
            {
  case 10: // arrelement: jvalue
#line 54 "parser.y"
                           {parser->storeArrElement();}
#line 591 "parser.tab.cc"
    break;

  case 11: // member: name COLON jvalue
#line 57 "parser.y"
                           {parser->storeMember();}
...
#line 609 "parser.tab.cc"
  ...
  case 14: // jvalue: STR
#line 66 "parser.y"
                  {parser->setValue(JValueType::Str);}
#line 615 "parser.tab.cc"
    break;

  case 15: // jvalue: NUM
#line 67 "parser.y"
                  {parser->setValue(JValueType::Num);}
#line 621 "parser.tab.cc"
    break;

  case 16: // jvalue: dictionary
#line 68 "parser.y"
                  {parser->setValue(JValueType::Dict);}
#line 627 "parser.tab.cc"
    break;

  case 17: // jvalue: array
#line 69 "parser.y"
                  {parser->setValue(JValueType::Arr);}
...
#line 637 "parser.tab.cc"
  ...
  {
       0,     6,     9,    14,    15,    16,    17,     0,    12,    13,
       0,     4,     0,     0,     7,    10,     1,     2,     6,     0,
       3,     9,     5,    11,     8
  };
  ...
  {
       0,     5,     6,    10,    13,    14,    11,    12,    15
  };

  const signed char
  ParserBase::yytable_[] =
  {
       7,     1,    16,     2,     8,     9,     3,     4,    17,    20,
      18,    19,    22,    24,     0,     0,    21,     0,     0,    23
  };
  ...
  {
       0,     3,     0,     5,     7,     8,     8,     9,     4,     6,
      11,    10,    18,    21,    -1,    -1,    11,    -1,    -1,    19
  };

  const signed char
  ParserBase::yystos_[] =
  {
       0,     3,     5,     8,     9,    13,    14,    20,     7,     8,
      15,    18,    19,    16,    17,    20,     0,     4,    11,    10,
       6,    11,    15,    20,    16
  };
  ...
  "CB", "ID", "STR", "NUM", "COLON", "COMMA", "$accept", "dictionary",
  "array", "memberlist", "valuelist", "arrelement", "member", "name",
  "jvalue", YY_NULLPTR
  };
#endif
  ...
  ParserBase::yyrline_[] =
  {
       0,    38,    38,    42,    45,    46,    47,    50,    51,    52,
      54,    57,    61,    62,    66,    67,    68,    69
  };
