...
# endif
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_dictionary = 13,                       // dictionary
        S_array = 14,                            // array
        S_memberlist = 15,                       // memberlist
        S_valuelist = 16,                        // valuelist
        S_arrelement = 17,                       // arrelement
        S_member = 18,                           // member
        S_name = 19,                             // name
        S_jvalue = 20                            // jvalue
      };
    ...
    ParserBase (Parser *driver_yyarg);
    virtual ~ParserBase ();
