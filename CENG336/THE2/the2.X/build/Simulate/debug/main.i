...
static const Tetromino DOT = {.type = 0, .x = 0, .y = 0, .shape = { .byte = 0x80 }};
static const Tetromino SQUARE = {.type = 1, .x = 0, .y = 0, .shape = { .byte = 0xF0 }};
static const Tetromino L = {.type = 2, .x = 0, .y = 0, .shape = { .byte = 0xE0 }};
...
char IsColliding(char dir0, char dir1);

void RotateShape(Shape *shape);
char ShapeInBounds(char dir0, char dir1);
...
void GetQuartet(char x, char y, Shape *shape, Board* board)
{
    shape->b0 = (((x) < 0) || ((x) > 3) || ((y) > 7) || ((y) < 0)) ? 1 : GetBoard(x, y, board);
    shape->b1 = (((x + 1) < 0) || ((x + 1) > 3) || ((y) > 7) || ((y) < 0)) ? 1 : GetBoard(x + 1, y, board);
    shape->b2 = (((x + 1) < 0) || ((x + 1) > 3) || ((y + 1) > 7) || ((y + 1) < 0)) ? 1 : GetBoard(x + 1, y + 1, board);
    shape->b3 = (((x) < 0) || ((x) > 3) || ((y + 1) > 7) || ((y + 1) < 0)) ? 1 : GetBoard(x, y + 1, board);
}

void GetQuartet2(char x, char y, Shape *shape)
{
    shape->b0 = (((x) < 0) || ((x) > 3) || ((y) > 7) || ((y) < 0)) ? 1 : 0;
    shape->b1 = (((x + 1) < 0) || ((x + 1) > 3) || ((y) > 7) || ((y) < 0)) ? 1 : 0;
    shape->b2 = (((x + 1) < 0) || ((x + 1) > 3) || ((y + 1) > 7) || ((y + 1) < 0)) ? 1 : 0;
    shape->b3 = (((x) < 0) || ((x) > 3) || ((y + 1) > 7) || ((y + 1) < 0)) ? 1 : 0;
}
...
void HandlePortB()
{
    ...
    char changedBits = currentPortB ^ lastPortB;
