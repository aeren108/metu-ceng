...
void GetQuartet(char x, char y, Shape *shape)
{
    ...
    shape->b1 = (x + 1 < 0 || x + 1 > 3 || y > 7 || y < 0) ? 1 : GetBoard(x + 1, y);
    shape->b2 = (x + 1 < 0 || x + 1 > 3 || y + 1 > 7 || y + 1 < 0) ? 1 : GetBoard(x + 1, y + 1);
    shape->b3 = (x < 0 || x > 3 || y + 1 > 7 || y + 1 < 0) ? 1 : GetBoard(x, y + 1);
}
