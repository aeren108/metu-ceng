...
public class Evaluation {
    ...
    private static String user = "e2587921"; // TODO: Your userName
    private static String password = "^W2OV*U9+^Xh"; //  TODO: Your password
    private static String host = "144.122.71.128"; // host name
    private static String database = "db2587921"; // TODO: Your database name
